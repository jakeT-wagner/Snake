...
let calls = 0; // velocity control. moves the box every third animation frame(calls %3)
let boxSize = 15;
...
let model = {boxes: [], targetRow: 10, targetCol: 10, right:true, down:true, direction:false, moving:false, gameOver:false, maxScore:1 };
    ...
    function render(xVel,yVel) {
        ...
        if (model.boxes.length >1 )  {
            ...
            let str = "Length: " + length + " High Score: " + model.maxScore;
    ...
    function createNewTarget() {
        ...
        while (!acceptable) {
            ...
            if (model.grid[model.targetRow][model.targetCol] == false) {
                acceptable = true;
            }
        }
    }
